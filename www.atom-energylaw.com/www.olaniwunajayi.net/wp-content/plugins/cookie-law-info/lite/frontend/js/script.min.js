! function(e) {
    ...
    function p() {
        ...
        function() {
            ...
            P(),
                ...
                function() {
                    ...
                    a("=settings-button", () => M("settings-button")), a("=detail-close", () => $()), a("=optout-cancel-button", () => $()), a("=close-button", () => (c._ckySetInStore("action", "yes"), void g())), a("=donotsell-button", () => M("donotsell-button")), a("=reject-button", H("reject")), a("=accept-button", H("all")), a("=detail-accept-button", H("all")), a("=detail-save-button", H()), a("=detail-category-preview-save-button", H()), a("=optout-confirm-button", H()), a("=detail-reject-button", H("reject")), a("=revisit-consent", () => _revisitCkyConsent()), a("=optout-close", () => $())
                }(),
                function() {
                ...
                function() {
                    if (!n._bannerConfig.config.alwaysActive) return;
                ...
                function() {
                    if (!n._bannerConfig.config.manualLinks) return;
        ...
        function() {
            ...
            function y() {
                i.innerHTML = `${u}${c}`, a("=hide-desc-button", f), J()
            }

            function f() {
                i.innerHTML = d, a("=show-desc-button", y), J()
            }
            f()
    ...
    function $() {
        const e = E();
        e && e.classList.remove(x()), "classic" !== h() ? (A(), c._ckyGetFromStore("action") || w()) : (k("=settings-button", "false"), u("=notice", "cky-consent-bar-expand")), c._ckyGetFromStore("action") && I();
    ...
    function T() {
        ...
        "classic" !== h() ? (L(), S()) : (k("=settings-button"), function() {
            d("add", ...arguments)
    ...
    function q() {
        const e = E();
        if (!e) return;
        e.classList.toggle(x()), "pushdown" !== C() && function() {
            const e = document.querySelector(".cky-overlay");
            e && e.classList.toggle("cky-hide")
        }();
        const t = e.classList.contains(x());
        if (e.classList.toggle(x()), "classic" === h()) {
            const t = e.querySelector(".cky-preference-center");
            if (t) {
                t.setAttribute("role", "dialog"), t.setAttribute("aria-modal", "true");
                const e = "ccpa" === _() ? "Opt-out Preferences" : "Customise Consent Preferences";
        ...
        } else t ? (A(), c._ckyGetFromStore("action") || w()) : (L(), S());
    ...
    function M(e = !1) {
        n._preferenceOriginTag = e, "classic" === h() ? (q(), k("=settings-button")) : T()
    }
        ...
        return () => {
            ! function(e = "all") {
                ...
                for (const s of n._categories) {
                    let n = "no";
                    n = "gdpr" === t ? s.isNecessary || "reject" !== e && ("custom" !== e || V(s.slug)) ? "yes" : "no" : o && !s.defaultConsent.ccpa ? "no" : "yes", c._ckySetInStore("" + s.slug, n), "no" === n ? (r.rejected.push(s.slug), N(s)) : r.accepted.push(s.slug)
                }
                U(), f(r)
            }(e), g(), $(),
                function() {
        ...
        for (const {
            ...
            for (const e of t)
                if (e.src && e.nodeName && ["script", "iframe"].includes(e.nodeName.toLowerCase())) try {
                    ...
                    if ("iframe" === e.nodeName.toLowerCase()) X(e, i);
                    else {
    ...
    function J() {
        if (!n._bannerConfig.config.showMore || !n._bannerConfig.config.showLess) return;
